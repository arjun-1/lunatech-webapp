...
insert into `Airport` select * from csvread('dist/airports.csv', null, 'fieldDelimiter=" fieldSeparator=, lineSeparator=\n');
insert into `Country` select * from csvread('dist/countries.csv', null, 'fieldDelimiter=" fieldSeparator=, lineSeparator=\n');
insert into `Runway` select * from csvread('dist/runways.csv', null, 'fieldDelimiter=" fieldSeparator=, lineSeparator=\n');
